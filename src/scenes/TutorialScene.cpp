...
namespace
{
    ...
    constexpr std::array<TutorialPopupDefinition, 9> PopupDefinitions{{
        ...
        },
        {
            ...
            "A Hunter's Hut supplies {resource}Meat{/resource}. The Inn consumes Bread, Meat and Water to produce {resource}Food Provisions{/resource} — it does not produce beer. "
