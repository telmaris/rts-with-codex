...
- [~] Etap 4 — InputManager (observer) — 4.1 zrobione i poprawione (2026-07-05: naprawiono bug RAII — singleton + raw-pointer subscribers zamiast kopiującego shared_ptr), 4.2 zrobione (KeyBindingMap), 4.3-4.4 (podpięcie do GuiController, usunięcie Input.h) DO ZROBIENIA — wysokie ryzyko bez możliwości manualnego testu GUI w tym środowisku
