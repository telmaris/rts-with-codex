...
| Tryby interakcji mapy (build, road, destroy…) | `inc/GuiController.h` — `GuiSystem` i pochodne; `src/GuiController.cpp` |
| Panel statystyk, focus tree, HUD zasobów | `inc/GuiController.h` — `StatsPanelWidget`, `FocusPanelWidget`, `StrategicResourceHudWidget` |
